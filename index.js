...
const logicsBtn = document.querySelector(".chapters__btn_logics");
...
logicsBtn.addEventListener("click", function (e) {
    outer.insertAdjacentHTML('afterend', renderObjectList(e, logics));
});
